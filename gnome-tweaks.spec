...
Version  : 3.33.90
Release  : 11
URL      : https://download.gnome.org/sources/gnome-tweaks/3.33/gnome-tweaks-3.33.90.tar.xz
Source0  : https://download.gnome.org/sources/gnome-tweaks/3.33/gnome-tweaks-3.33.90.tar.xz
...
%prep
%setup -q -n gnome-tweaks-3.33.90
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568130612
