...
Version  : 46.0
Release  : 45
URL      : https://download.gnome.org/sources/gnome-tweaks/46/gnome-tweaks-46.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-tweaks/46/gnome-tweaks-46.0.tar.xz
...
%prep
%setup -q -n gnome-tweaks-46.0
cd %{_builddir}/gnome-tweaks-46.0
pushd ..
cp -a gnome-tweaks-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710895584
