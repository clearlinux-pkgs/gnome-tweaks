...
Version  : 46.1
Release  : 47
URL      : https://download.gnome.org/sources/gnome-tweaks/46/gnome-tweaks-46.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-tweaks/46/gnome-tweaks-46.1.tar.xz
...
%prep
%setup -q -n gnome-tweaks-46.1
cd %{_builddir}/gnome-tweaks-46.1
pushd ..
cp -a gnome-tweaks-46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730210291
